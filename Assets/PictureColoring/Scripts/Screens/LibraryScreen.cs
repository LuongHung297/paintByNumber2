...
namespace BizzyBeeGames.PictureColoring
{
	public class LibraryScreen : Screen
	{
        ...
        LoadCateForPop loadcatepop;
        private void Start()
        {
			loadcatepop = GameObject.FindGameObjectWithTag("GameController").GetComponent<LoadCateForPop>();
		}
		...
		/// </summary>
		public void OnCategoryListItemSelected(int index, object data)
		{
			if (activeCategoryIndex != index)
			{
                // Set the CategoryListItem as selected
                SetCategoryListItemSelected(index);
				loadcatepop.SetCategoryListItemSelected(index);
