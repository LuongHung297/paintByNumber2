...
namespace BizzyBeeGames
{
	public class Popup : UIMonoBehaviour
	{
		...
		{
            animContainer = animContainer.GetComponent<RectTransform>();
		...
		public void Hide(bool cancelled, object[] outData)
		{
            ...
            if (isPushUp)
            {
                anim = UIAnimation.PositionY(animContainer, 1, -5000f, animDuration);
        ...
        {   // Start the popup show animations
            ...
            anim = UIAnimation.PositionY(animContainer, 1f, animDuration);
			anim.style = UIAnimation.Style.EaseOut;
            anim.startOnFirstFrame = true;
			anim.Play();
			isPushUp = true;
