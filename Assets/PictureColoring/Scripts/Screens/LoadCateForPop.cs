...
{
    public class LoadCateForPop : Screen
    {
        ...
        public void SetupCategoryList()
        {
            ...
            SetCategoryListItemSelected(StartIndex);
        }
        ...
        void OnCategoryListItemSelected(int index, object data)
        {
            if (activeCategoryIndex != index)
            {
                lbsc = GameObject.FindGameObjectsWithTag("GameController")[1].GetComponent<LibraryScreen>();
                lbsc.OnCategoryListItemSelected(index, data);
                // Set the CategoryListItem as selected
        ...
        /// </summary>
        public void SetCategoryListItemSelected(int index)
        {
